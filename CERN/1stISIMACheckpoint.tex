...
\section{Main goals of the internship}
...
I was sick during a part of this iteration, so I did not work effictively on Monday
\paragraph{Task done :}
\begin{itemize}
...
\paragraph{Notes :} 
I have been reading the documentation about the config files :
\begin{itemize}
...
To navigate properly, I think I should take a look at the Topologies panels components... The embedded modules through one root module, may be the best option.
